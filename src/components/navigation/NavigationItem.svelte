...
<div 
    class="cursor-pointer flex flex-row items-center mb-4 transition-all duration-300 ease-out hover:scale-105"
...
>
    <div class="w-14 h-14 rounded-full border-2 border-[#4d8933] bg-[#20640d] m-2 transition-all duration-300 flex items-center justify-center"
